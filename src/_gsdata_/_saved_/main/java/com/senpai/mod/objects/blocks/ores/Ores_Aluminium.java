...
public class Ores_Aluminium extends Block implements IHasModel, IMetaName
{
	...
	private static final String name = "ore_aluminium";
	private List<String> dimension = new ArrayList<String>();
	
	public Ores_Aluminium(EnumHandler.ElementType type, String... dimension) 
	{
		super(Material.ROCK);
