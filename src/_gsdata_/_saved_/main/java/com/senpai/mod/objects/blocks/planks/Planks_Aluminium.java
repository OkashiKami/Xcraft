...
public class Planks_Aluminium  extends Block implements IMetaName, IHasModel
{
	...
	private String name = "planks_aluminium";
	private EnumHandler.ElementType type;
	
	public Planks_Aluminium(EnumHandler.ElementType type) 
	{
		super(Material.WOOD);
		setUnlocalizedName(name);
		setRegistryName(name);
		setSoundType(SoundType.WOOD);
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.ElementType.ALUMINIUM));
