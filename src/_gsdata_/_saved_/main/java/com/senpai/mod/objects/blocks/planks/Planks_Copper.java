...
public class Planks_Copper  extends Block implements IMetaName, IHasModel
{
	...
	private String name = "planks_copper";
	private EnumHandler.ElementType type;
	
	public Planks_Copper(EnumHandler.ElementType type) 
	{
		super(Material.WOOD);
		setUnlocalizedName(name);
		setRegistryName(name);
		setSoundType(SoundType.WOOD);
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.ElementType.COPPER));
