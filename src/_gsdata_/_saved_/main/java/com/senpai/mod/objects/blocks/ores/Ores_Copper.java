...
public class Ores_Copper extends Block implements IHasModel, IMetaName
{
	...
	private static final String name = "ore_copper";
	private List<String> dimension = new ArrayList<String>();
	
	public Ores_Copper(EnumHandler.ElementType type, String... dimension) 
	{
		super(Material.ROCK);
