...
public class BiomeFoz extends Biome
{
	protected static final WorldGenAbstractTree TREE = new WorldGenCopperTree();
	
	public BiomeFoz() 
	{
		super(new BiomeProperties("Foz").setBaseHeight(1.5F).setHeightVariation(1.2F).setTemperature(0.6F)
		...
		this.spawnableCreatureList.add(new SpawnListEntry(EntityDragon.class, 10, 1, 1));
