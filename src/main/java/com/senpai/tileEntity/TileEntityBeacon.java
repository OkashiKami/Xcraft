...
// PARENT OFF THE ORIGINAL NET.MINECRAFT.TILEENTITY.TILEENTITYBEACON
...
public class TileEntityBeacon extends net.minecraft.tileentity.TileEntityBeacon {
	...
	public static final Potion[][] EFFECTS_LIST = new Potion[][] { { MobEffects.SPEED, MobEffects.HASTE },
			{ MobEffects.RESISTANCE, MobEffects.JUMP_BOOST }, { MobEffects.STRENGTH }, { MobEffects.INSTANT_HEALTH } };
	private static final Set<Potion> VALID_EFFECTS = Sets.<Potion>newHashSet();
	/** A list of beam segments for this beacon */
	private final List<net.minecraft.tileentity.TileEntityBeacon.BeamSegment> beamSegments = Lists.<net.minecraft.tileentity.TileEntityBeacon.BeamSegment>newArrayList();
	...
	private void updateSegmentColors() {
		...
		TileEntityBeacon.BeamSegment tileentitybeacon$beamsegment = new TileEntityBeacon.BeamSegment(
				EnumDyeColor.MAGENTA.getColorComponentValues());
	...
	@SideOnly(Side.CLIENT)
	public List<net.minecraft.tileentity.TileEntityBeacon.BeamSegment> getBeamSegments() {
	...
	public static class BeamSegment extends net.minecraft.tileentity.TileEntityBeacon.BeamSegment {
