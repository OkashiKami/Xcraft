...
public class BlockBreaker extends BlockMachine {
	 ...
	 * @param name The block's unlocalized name
	 */
	...
	public int getMetaFromState(IBlockState state) {
		...
		int meta = type.getMeta() * EnumFacing.values().length + facing.ordinal(); //Stores the type the EnumFacing in the meta
		return meta;
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if(!worldIn.isRemote) {
			playerIn.openGui(Main.instance,  Reference.GUI_BLOCK_BREAKER, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
		return true;
	}
