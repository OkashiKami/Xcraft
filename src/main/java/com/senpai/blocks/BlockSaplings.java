...
import com.senpai.world.gen.generators.WorldGenAluminiumTree;
...
{	
    ...
    public BlockSaplings(String name) 
    {
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.MinaralType.COPPER).withProperty(STAGE, Integer.valueOf(0)));
	...
	{
		return this.getDefaultState().withProperty(VARIANT, EnumHandler.MinaralType.byMetadata(meta & 1)).withProperty(STAGE, Integer.valueOf((meta & 8) >> 3));
	}
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "sapling_" + EnumHandler.MinaralType.values()[i].getName(), "inventory");
		}
	}
	...
	public void generateTree(World world, Random rand, BlockPos pos, IBlockState state)
	{
		...
		switch((EnumHandler.MinaralType)state.getValue(VARIANT))
		{
		case COPPER:
