 ...
 * @author CJMinecraft
 * @param <RuntimeOptionGuiHandler>
 *
 */
public class ConfigGuiFactory<RuntimeOptionGuiHandler> implements IModGuiFactory {
	...
	public static class ConfigGui extends GuiConfig {
		...
		public static class CategoryEntryBlocks extends CategoryEntry {
			...
			protected GuiScreen buildChildScreen() {
				...
				ConfigElement categoryBlocks = new ConfigElement(config.getCategory(Config.CATEGORY_NAME_BLOCKS));
