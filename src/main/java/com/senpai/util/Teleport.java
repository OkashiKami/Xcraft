...
public class Teleport extends Teleporter
{
	...
	@Override
	public void placeInPortal(Entity entityIn, float rotation)
	{
	...
	public static void teleportToDimension(EntityPlayer player, int dimension, double x, double y, double z)
	{
		...
		worldServer.getMinecraftServer().getPlayerList().transferPlayerToDimension(playerMP, dimension, new Teleport(worldServer, x, y, z));
